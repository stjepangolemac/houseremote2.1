 ...
 *
 */
let decorate = require("inversify").decorate;
let injectable = require("inversify").injectable;
...
//
let temp = function(options) {
    events.EventEmitter.call(this);
    this.configure(options);
};
decorate(injectable(), temp);

/*var Logger = exports.Logger = function(options) {
    events.EventEmitter.call(this);
    this.configure(options);
};*/
var Logger = exports.Logger = temp;
